...
(function ($) {
	...
	const CAT_AQUA = "aqua";
	const CAT_BIRD = "bird";
	const CAT_FLOWER = "flower";

	const CAT_MGZN = "magazine";
	const CAT_LOGO = "logo";
	const CAT_ART = "art";
	...
	function getMetadata() {
		return [
...

			{
				id: "EG-1",
				title: "EtherGlass #1",
				catergory: CAT_MATH + " " + CAT_MAIN + " " + CAT_POLY + " " + CAT_10,
...

			{
				id: "EG-2",
				title: "EtherGlass #2",
				catergory: CAT_MATH + " " + CAT_MAIN + " " + CAT_DISC + " " + CAT_POLY + " " + CAT_1,
...

			{
				id: "EG-4",
				title: "EtherGlass #4",
				catergory: CAT_PLANT + " " + CAT_MAIN + " " + CAT_POLY + " " + CAT_10,
			...
			},
			{
				id: "EG-6",
				title: "EtherGlass #6",
				catergory: CAT_PLANT + " " + CAT_MAIN + " " + CAT_FLOWER + " " + CAT_POLY + " " + CAT_1,
...

			{
				id: "EG-9",
				title: "EtherGlass #9",
				catergory: CAT_PLANT + " " + CAT_MAIN + " " + CAT_FLOWER + " " + CAT_POLY,
...

			{
				id: "EG-10",
				title: "EtherGlass #10",
				catergory: CAT_MATH + " " + CAT_MAIN + " " + CAT_POLY,
...

			{
				id: "EG-K",
				title: "EtherGlass #K",
				catergory: CAT_ICON + " " + CAT_MAIN + " " + CAT_POLY + " " + CAT_1,
...

			{
				id: "EG-12",
				title: "EtherGlass #12",
				catergory: CAT_MATH + " " + CAT_MAIN + " " + CAT_POLY + " " + CAT_1,
			...
			},
			{
				id: "EG-14",
				title: "EtherGlass #14",
				catergory: CAT_OTHER + " " + CAT_MAIN + " " + CAT_AQUA + " " + CAT_POLY,
			...
			},
			{
				id: "EG-15",
				title: "EtherGlass #15",
				catergory: CAT_ICON + " " + CAT_MAIN + " " + CAT_DOGE + " " + CAT_POLY,
			...
			},
			{
				id: "EG-18",
				title: "EtherGlass #18",
				catergory: CAT_ANIMAL + " " + CAT_LUCK + " " + CAT_MAIN + " " + CAT_AQUA + " " + CAT_POLY,
			...
			},
			{
				id: "EG-19",
				title: "EtherGlass #19",
				catergory: CAT_ANIMAL + " " + CAT_LUCK + " " + CAT_MAIN + " " + CAT_POLY,
			...
			},
			{
				id: "EG-20",
				title: "EtherGlass #20",
				catergory: CAT_ANIMAL + " " + CAT_MAIN + " " + CAT_BIRD + " " + CAT_POLY,
			...
			},
			{
				id: "ZERO-1",
				title: "ZERO #1",
				catergory: CAT_ANIMAL + " " + CAT_ZERO + " " + CAT_POLY + " " + CAT_10,
			...
			},
			{
				id: "ZERO-2",
				title: "ZERO #2",
				catergory: CAT_MATH + " " + CAT_ZERO + " " + CAT_DISC + " " + CAT_POLY + " " + CAT_10,
			...
			},
			{
				id: "EG-21",
				title: "EtherGlass #21",
				catergory: CAT_ANIMAL + " " + CAT_MAIN + " " + CAT_DOGE + " " + CAT_POLY,
			...
			},
			{
				id: "EG-22",
				title: "EtherGlass #22",
				catergory: CAT_ANIMAL + " " + CAT_MAIN + " " + CAT_POLY,
			...
			},
			{
				id: "EG-25",
				title: "EtherGlass #25",
				catergory: CAT_OTHER + " " + CAT_MAIN + " " + CAT_POLY + " " + CAT_10,
			...
			},
			{
				id: "EG-26",
				title: "EtherGlass #26",
				catergory: CAT_ANIMAL + " " + CAT_MAIN + " " + CAT_CAT + " " + CAT_POLY + " " + CAT_10,
			...
			},
			{
				id: "EG-28",
				title: "EtherGlass #28",
				catergory: CAT_ANIMAL + " " + CAT_MAIN + " " + CAT_AQUA + " " + CAT_POLY,
			...
			},
			{
				id: "EG-30",
				title: "EtherGlass #30",
				catergory: CAT_ANIMAL + " " + CAT_DARK + " " + CAT_MAIN + " " + CAT_AQUA + " " + CAT_POLY + " " + CAT_10,
			...
			},
			{
				id: "EG-32",
				title: "EtherGlass #32",
				catergory: CAT_ANIMAL + " " + CAT_LUCK + " " + CAT_BIRD + " " + CAT_MAIN + " " + CAT_POLY,
			...
			},
			{
				id: "EG-D",
				title: "EtherGlass #D",
				catergory: CAT_MATH + " " + CAT_MAIN + " " + CAT_ETH,
			...
			},
			{
				id: "EG-35",
				title: "EtherGlass #35",
				catergory: CAT_ANIMAL + " " + CAT_LUCK + " " + CAT_MAIN + " " + CAT_AQUA + " " + CAT_ETH + " " + CAT_1,
			...
			},
			{
				id: "EG-37",
				title: "EtherGlass #37",
				catergory: CAT_MATH + " " + CAT_DARK + " " + CAT_MAIN + " " + CAT_POLY,
			...
			},
			{
				id: "EG-I",
				title: "EtherGlass #I",
				catergory: CAT_MATH + " " + CAT_MAIN + " " + CAT_ETH + " " + CAT_1,
			...
			},
			{
				id: "EG-39",
				title: "EtherGlass #39",
				catergory: CAT_ANIMAL + " " + CAT_MAIN + " " + CAT_DARK + " " + CAT_ETH + " " + CAT_1,
			...
			},
			{
				id: "EG-40",
				title: "EtherGlass #40",
				catergory: CAT_ANIMAL + " " + CAT_MAIN + " " + CAT_DARK + " " + CAT_POLY,
			...
			},
			{
				id: "EG-41",
				title: "EtherGlass #41",
				catergory: CAT_ANIMAL + " " + CAT_MAIN + " " + CAT_ETH + " " + CAT_1,
			...
			},
			{
				id: "EG-43",
				title: "EtherGlass #43",
				catergory: CAT_ANIMAL + " " + CAT_BIRD + " " + CAT_MAIN + " " + CAT_ETH + " " + CAT_1,
			...
			},
			{
				id: "EG-46",
				title: "EtherGlass #46",
				catergory: CAT_ANIMAL + " " + CAT_MAIN + " " + CAT_CAT + " " + CAT_ETH + " " + CAT_1,
				...
				id: "EG-47",
				title: "EtherGlass #47",
				catergory: CAT_ANIMAL + " " + CAT_MAIN + " " + CAT_CAT + " " + CAT_POLY,
				...
				id: "EG-51",
				title: "EtherGlass #51",
				catergory: CAT_ANIMAL + " " + CAT_DARK + " " + CAT_MAIN + " " + CAT_POLY + " " + CAT_10,
				...
				id: "EG-B",
				title: "EtherGlass #B",
				catergory: CAT_ANIMAL + " " + CAT_LUCK + " " + CAT_MAIN + " " + CAT_DOGE + " " + CAT_POLY,
				...
				id: "EG-53",
				title: "EtherGlass #53",
				catergory: CAT_DARK + " " + CAT_MAIN + " " + CAT_POLY,
				...
				id: "EG-M",
				title: "EtherGlass #M",
				catergory: CAT_MOMENT + " " + CAT_MAIN + " " + CAT_POLY,
				...
				id: "ZERO-3",
				title: "ZERO #3",
				catergory: CAT_ICON + " " + CAT_ARCH + " " + CAT_ZERO + " " + CAT_POLY + " " + CAT_10,
				...
				id: "EG-55",
				title: "EtherGlass #55",
				catergory: CAT_ANIMAL + " " + CAT_MAIN + " " + CAT_XTZ,
				...
				id: "EG-58",
				title: "EtherGlass #58",
				catergory: CAT_MATH + " " + CAT_MAIN + " " + CAT_XTZ,
				...
				id: "EG-F",
				title: "EtherGlass #F",
				catergory: CAT_ANIMAL + " " + CAT_LUCK + " " + CAT_BIRD + " " + CAT_MAIN + " " + CAT_AQUA + " " + CAT_POLY,
				...
				id: "EG-60",
				title: "EtherGlass #60",
				catergory: CAT_CRYPTO + " " + CAT_MAIN + " " + CAT_POLY,
				...
				catergory: CAT_ICON + " " + CAT_CRYPTO + " " + CAT_POLY,
				...
				id: "EG-T",
				title: "EtherGlass #T",
				catergory: CAT_OTHER + " " + CAT_MAIN + " " + CAT_POLY,
				...
				id: "EG-61",
				title: "EtherGlass #61",
				catergory: CAT_ARCH + " " + CAT_MAIN + " " + CAT_POLY,
				...
				id: "1ETH",
				title: "ONE ETH",
				catergory: CAT_CRYPTO + " " + CAT_ONE + " " + CAT_POLY + " " + CAT_10,
				...
				catergory: CAT_ANIMAL + " " + CAT_ONE + " " + CAT_POLY + " " + CAT_10,
				...
				catergory: CAT_ANIMAL + " " + CAT_ONE + " " + CAT_POLY + " " + CAT_10 + " " + CAT_LOGO,
				...
				catergory: CAT_ANIMAL + " " + CAT_ICON + " " + CAT_DOGE + " " + CAT_LOGO + " " + CAT_POLY,
				...
				catergory: CAT_ANIMAL + " " + CAT_CAT + " " + CAT_POLY,
				...
				catergory: CAT_ANIMAL + " " + CAT_DOGE + " " + CAT_POLY,
				...
				catergory: CAT_ICON + " " + CAT_LOGO + " " + CAT_ART + " " + CAT_MGZN + " " + CAT_POLY,
				...
				catergory: CAT_ANIMAL + " " + CAT_AQUA + " " + CAT_POLY,
				...
				catergory: CAT_ICON + " " + CAT_LOGO + " " + CAT_ART + " " + CAT_POLY,
				...
				catergory: CAT_ICON + " " + CAT_LOGO + " " + CAT_POLY,
				...
				id: "EG-65",
				title: "EtherGlass #65",
				catergory: CAT_ANIMAL + " " + CAT_CAT + " " + CAT_POLY + " " + CAT_MAIN,
				...
				catergory: CAT_ICON + " " + CAT_LOGO + " " + CAT_MGZN + " " + CAT_POLY,
				...
				catergory: CAT_CRYPTO + " " + CAT_MOMENT + " " + CAT_ICON + " " + CAT_MGZN + " " + CAT_POLY,
				...
				catergory: CAT_ICON + " " + CAT_ART + " " + CAT_POLY + " " + CAT_10,
				...
				catergory: CAT_ART + " " + CAT_DARK + " " + CAT_MGZN + " " + CAT_LOGO + " " + CAT_POLY,
				...
				id: "EG-66",
				title: "EtherGlass #66",
				catergory: CAT_MAIN + " " + CAT_POLY + " " + CAT_AQUA + " " + CAT_ARCH,
				picPath: "images/nfts/EG66.jpeg",
				marketplace: "OpenSea",
				itemLink: "https://opensea.io/assets/matic/0x2953399124f0cbb46d2cbacd8a89cf0599974963/76505008690628832182644120658996052592304759113794803818016025760665620709442"
			}, {
				id: "picasso2",
				title: "EtherGlass Picasso II",
				catergory: CAT_ICON + " " + CAT_ART + " " + CAT_POLY,
				picPath: "images/nfts/picasso2.jpeg",
				marketplace: "OpenSea",
				itemLink: "https://opensea.io/assets/matic/0x2953399124f0cbb46d2cbacd8a89cf0599974963/76505008690628832182644120658996052592304759113794803818016025747471481176074"
			}, {
				id: "w1",
